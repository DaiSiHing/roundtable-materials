...
|---|---|---|---|
| `coupled_mc.py` | . Coupled-tail engine - Student-t copula, rotated-Clayton directional bound. | 11.2 kB | MIT |
...
| `coupled_results.json` |  | 5.1 kB | CC BY 4.0 |
| `coupled_tail_mc.py` | . Tail simulation variant. | 10.5 kB | MIT |
...
can be audited. In the file table above, the one-line descriptions of these two
scripts are as published in the page's file list, where they are attached to the
wrong files; that has been flagged to the editor for correction on the site.
